...
#ifndef INC_STM32F103C8_EXTI_H_
#define INC_STM32F103C8_EXTI_H_
...
typedef struct
{
	...
	uint8_t				IRQ_EN;			//Enable or Disable the EXTI_IEQ (that will enable the IRQ MASK in EXTI and also on the NVIC interrupt controller)
